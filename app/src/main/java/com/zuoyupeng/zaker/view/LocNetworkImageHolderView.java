 ...
 * 网络图片加载例子
 */
public class LocNetworkImageHolderView implements Holder<BeijingBean.Gallery> {
    ...
    @Override
    public void UpdateUI(Context context, int position, BeijingBean.Gallery date) {
